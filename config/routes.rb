Rails.application.routes.draw do
  ...
  get 'checkin/:conference', to: 'pages#checkin'
  ...
  namespace :api do
    ...
    post '/imports/students', to: 'imports#checkin'
    get '/searchables/checkin', to: 'searchables#checkin'
    ...
    patch '/students/checkin/:id', to: 'students#checkin'
