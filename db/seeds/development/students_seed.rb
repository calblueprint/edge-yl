(1..50).each do |index|
  new_student = Student.create!(
    ...
    guardian_employer: Faker::Name,
    guardian_first_name: Faker::Internet.email,
    guardian_job_title: Faker::Name.name,
    guardian_last_name: Faker::PhoneNumber.phone_number,
    guardian_phone_number: Faker::Internet.email,
